...
import { LMInfoProductProps } from "./types";
...
const LMInfoProduct: React.FC<LMInfoProductProps> = ({
  product,
  onClickFav,
  onClickBuy,
}) => {
  ...
  return (
    <LMBaseComponent classNameXtra={styles.widthCont}>
